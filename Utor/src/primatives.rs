use vek::Vec3;
use corale::mesh::{Mesh, Vertex, Face};
...
pub fn make_cube(pos: Vec3<f64>, size: Vec3<f64>, mesh: &mut Mesh<f64>) {
    ...
    mesh.add_face(Face::new(vec![v2,v6,v4,v0]));
    mesh.add_face(Face::new(vec![v7,v6,v2,v3]));
    mesh.add_face(Face::new(vec![v5,v4,v6,v7]));
    mesh.add_face(Face::new(vec![v7,v3,v1,v5]));
    mesh.add_face(Face::new(vec![v3,v2,v0,v1]));
    mesh.add_face(Face::new(vec![v1,v0,v4,v5]));
}
