...
pub fn make_cube(pos: Vec3<f64>, size: Vec3<f64>, mesh: &mut Mesh) {
    let size = size / 2.;
...
pub fn make_box(a: Vec3<f64>, b: Vec3<f64>, mesh: &mut Mesh) {
    let v0 = mesh.add_vertex(Vec3::new(b.x, b.y, a.z));
    let v1 = mesh.add_vertex(Vec3::new(b.x, a.y, a.z));
    let v2 = mesh.add_vertex(Vec3::new(b.x, b.y, b.z));
    let v3 = mesh.add_vertex(Vec3::new(b.x, a.y, b.z));
    let v4 = mesh.add_vertex(Vec3::new(a.x, b.y, a.z));
    let v5 = mesh.add_vertex(Vec3::new(a.x, a.y, a.z));
    let v6 = mesh.add_vertex(Vec3::new(a.x, b.y, b.z));
    let v7 = mesh.add_vertex(Vec3::new(a.x, a.y, b.z));
    mesh.add_face(vec![v2,v6,v4,v0]);
    mesh.add_face(vec![v7,v6,v2,v3]);
    mesh.add_face(vec![v5,v4,v6,v7]);
    mesh.add_face(vec![v7,v3,v1,v5]);
